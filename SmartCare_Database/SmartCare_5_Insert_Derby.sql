...
INSERT INTO users (USERPREFIX ,USERFIRSTNAME, USERSURNAME, pass, email, DOB, created, last_access, logged_in, USERTYPE, user_status_usid)
VALUES ('Mr', 'Rob', 'Smith', 'password', 'RobSmith@patient.com', '2000-10-10', '2020-12-12', '2020-12-12', 0, 'patient', 2);
INSERT INTO users (USERPREFIX ,USERFIRSTNAME, USERSURNAME, pass, email, DOB, created, last_access, logged_in, USERTYPE, user_status_usid)
VALUES ('Ms', 'Liz', 'Brown', 'password', 'RobSmith@patient.com', '2000-10-10', '2020-12-12', '2020-12-12', 0, 'patient', 2);
INSERT INTO users (USERPREFIX ,USERFIRSTNAME, USERSURNAME, pass, email, DOB, created, last_access, logged_in, USERTYPE, user_status_usid)
VALUES ('Mr', 'Max', 'Hesitant', 'password', 'MaxHesitant@patient.com', '2000-10-10', '2020-12-12', '2020-12-12', 0, 'patient', 2);
INSERT INTO users (USERPREFIX ,USERFIRSTNAME, USERSURNAME, pass, email, DOB, created, last_access, logged_in, USERTYPE, user_status_usid)
VALUES ('Mr', 'Mike', 'Park', 'password', 'MikePark@patient.com', '2000-10-10', '2020-12-12', '2020-12-12', 0, 'patient', 2);
INSERT INTO users (USERPREFIX ,USERFIRSTNAME, USERSURNAME, pass, email, DOB, created, last_access, logged_in, USERTYPE, user_status_usid)
VALUES ('Mrs', 'Julia', 'Carines', 'password', 'JuliaCarines@patient.com', '2000-10-10', '2020-12-12', '2020-12-12', 0, 'patient', 2);
