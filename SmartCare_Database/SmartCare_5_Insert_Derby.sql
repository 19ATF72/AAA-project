...
VALUES ('Dr', 'Root', 'Admin', 'root', 'root@admin.com', '1999-10-10', '2020-12-12', '2020-12-12', 0, 'admin', 2);
INSERT INTO users (USERPREFIX ,USERFIRSTNAME, USERSURNAME, pass, email, DOB, created, last_access, logged_in, USERTYPE, user_status_usid)
VALUES ('Dr', 'Tom', 'First', 'password', 'TomFirst@smartcare.com', '1980-10-10', '2020-12-12', '2020-12-12', 0, 'doctor', 2);
INSERT INTO users (USERPREFIX ,USERFIRSTNAME, USERSURNAME, pass, email, DOB, created, last_access, logged_in, USERTYPE, user_status_usid)
VALUES ('Ms', 'Judy', 'Best', 'password', 'JudyBest@smartcare.com', '1970-06-10', '2020-12-12', '2020-12-12', 0, 'nurse', 2);
...
VALUES ('Mr', 'Rob', 'Smith', 'password', 'RobSmith@patient.com', '2000-10-10', '2020-12-12', '2020-12-12', 0, 'patient', '07406402094', 2);
INSERT INTO users (USERPREFIX ,USERFIRSTNAME, USERSURNAME, pass, email, DOB, created, last_access, logged_in, USERTYPE, phone_number, user_status_usid)
VALUES ('Ms', 'Liz', 'Brown', 'password', 'RobSmith@patient.com', '2000-10-10', '2020-12-12', '2020-12-12', 0, 'patient', '07530219756', 2);
INSERT INTO users (USERPREFIX ,USERFIRSTNAME, USERSURNAME, pass, email, DOB, created, last_access, logged_in, USERTYPE, phone_number, user_status_usid)
VALUES ('Mr', 'Max', 'Hesitant', 'password', 'MaxHesitant@patient.com', '2000-10-10', '2020-12-12', '2020-12-12', 0, 'patient', '07530219756', 2);
INSERT INTO users (USERPREFIX ,USERFIRSTNAME, USERSURNAME, pass, email, DOB, created, last_access, logged_in, USERTYPE, phone_number, user_status_usid)
VALUES ('Mr', 'Mike', 'Park', 'password', 'MikePark@patient.com', '2000-10-10', '2020-12-12', '2020-12-12', 0, 'patient', '07928582641', 2);
INSERT INTO users (USERPREFIX ,USERFIRSTNAME, USERSURNAME, pass, email, DOB, created, last_access, logged_in, USERTYPE, phone_number, user_status_usid)
VALUES ('Mrs', 'Julia', 'Carines', 'password', 'JuliaCarines@patient.com', '2000-10-10', '2020-12-12', '2020-12-12', 0, 'patient', '07928582641', 2);
